...
@section('title', 'Créer un Utilisateur Backoffice')
...
@section('content')
    <div class="mb-4">
        ...
        <h4 class="fw-bold"><i class="bi bi-person-plus text-primary me-2"></i>Créer un Utilisateur Backoffice</h4>
    </div>

    <div class="card border-0 shadow-sm col-lg-8">
        <div class="card-body p-4">
            <form action="{{ route('manager.backoffice.store') }}" method="POST">
                @csrf
