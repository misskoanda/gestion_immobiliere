...
@section('content')
    <div class="mb-4">
        ...
        <h4 class="fw-bold"><i class="bi bi-person-plus text-primary me-2"></i>Créer un Client</h4>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('is_active') is-invalid @enderror" id="is_active" name="is_active" required>
                            <option value="1" {{ old('is_active', '1') === '1' ? 'selected' : '' }}>Validé (Actif)</option>
                            <option value="0" {{ old('is_active') === '0' ? 'selected' : '' }}>En attente de validation (Inactif)</option>
                        </select>
